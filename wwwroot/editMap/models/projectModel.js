app.ProjectModel = app.PointModel.fullExtend({
    defaults: {},
    initialize: function () {
        ...
        options.success = function (resp) {
            ...
            var message = {"layer": "project", "success": true, "message": "Project Saved Successfully."};
        ...
        {
            //console.log(resp);
            var message = {"layer": "project", "success": false, "message": "Error  Saving Project."};
            app.writeStatusMessage(message);
        }
    ...
    setFeatureAttributes: function (feature)
    {
        ...
        feature.name = this.get('pro_name');
    },
    ...
    delete_feature: function ()
    {
        ...
        {
            $.ajax({
                url: base_url + "Draw/project/" + pid + "/" + this.id,
                type: 'DELETE',
                ...
                error: function (e)
                {
                    alert("Please check if you are connected to internet2.");
                }
            });
        } else {
