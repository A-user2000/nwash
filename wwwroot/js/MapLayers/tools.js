...
var ToolHelper = function (objName, _tool, _name, _active, _node, _activeClass, _inactiveClass, _mouseOverClass, _mouseOutClass, _cursor) {
                    ...
                    if (url1) {
                        $.ajax({
                            ...
                            success: function (data) {
                                 ...
                                 */
                                //var aluminiumkey = ['parameter_name', 'sampling_time', 'lower_range', 'upper_range', 'pvalues', 'result_range'];
                                //var aluminiumkeyDisplay = ['Parameter Name:', 'Sampling Time:', 'Lower Range:', 'Upper Range:', 'Value:', 'Result Range:'];
                                //var ammoniakey = ['parameter_name', 'sampling_time', 'lower_range', 'upper_range', 'pvalues', 'result_range'];
                                //var ammoniakeyDisplay = [];
                                //var arsenickey = ['parameter_name', 'sampling_time', 'lower_range', 'upper_range', 'pvalues', 'result_range'];
                                //var arsenickeyDisplay = [];
                                //var cadmiumkey = ['parameter_name', 'sampling_time', 'lower_range', 'upper_range', 'pvalues', 'result_range'];
                                //var cadmiumkeyDisplay = [];
                                //var calciumkey = ['parameter_name', 'sampling_time', 'lower_range', 'upper_range', 'pvalues', 'result_range'];
                                //var calciumkeyDisplay = [];
                                //var chloridekey = ['parameter_name', 'sampling_time', 'lower_range', 'upper_range', 'pvalues', 'result_range'];
                                //var chloridekeyDisplay = [];
                                //var chromiumkey = ['parameter_name', 'sampling_time', 'lower_range', 'upper_range', 'pvalues', 'result_range'];
                                //var chromiumkeyDisplay = [];
                                //var colorkey = ['parameter_name', 'sampling_time', 'lower_range', 'upper_range', 'pvalues', 'result_range'];
                                //var colorkeyDisplay = [];
                                //var copperkey = ['parameter_name', 'sampling_time', 'lower_range', 'upper_range', 'pvalues', 'result_range'];
                                //var copperkeyDisplay = [];
                                //var cyanidekey = ['parameter_name', 'sampling_time', 'lower_range', 'upper_range', 'pvalues', 'result_range'];
                                //var cyanidekeyDisplay = [];
                                //var electrical_conkey = ['parameter_name', 'sampling_time', 'lower_range', 'upper_range', 'pvalues', 'result_range'];
                                //var electrical_conkeyDisplay = [];
                                //var fcekey = ['parameter_name', 'sampling_time', 'lower_range', 'upper_range', 'pvalues', 'result_range'];
                                //var fcekeyDisplay = [];
                                //var fckey = ['parameter_name', 'sampling_time', 'lower_range', 'upper_range', 'pvalues', 'result_range'];
                                //var fckeyDisplay = [];
                                //var flouridekey = [];
                                //var flouridekeyDisplay = [];
                                //var ironkey = [];
                                //var ironkeyDisplay = [];
                                //var leadkey = [];
                                //var leadkeyDisplay = [];
                                //var manganesekey = [];
                                //var manganesekeyDisplay = [];
                                //var mercurykey = [];
                                //var mercurykeyDisplay = [];
                                //var nitratekey = [];
                                //var nitratekeyDisplay = [];
                                //var nitriteskey = [];
                                //var nitriteskeyDisplay = [];
                                //var phkey = [];
                                //var phkeyDisplay = [];
                                //var rckey = [];
                                //var rckeyDisplay = [];
                                //var sulphatekey = [];
                                //var sulphatekeyDisplay = [];
                                //var tokey = [];
                                //var tokeyDisplay = [];
                                //var tckey = [];
                                //var tckeyDisplay = [];
                                ...
                                /* Water Quality Lab */
                                var wqlDWSSMkey = ['lab_name', 'address'];
                                var wqlDWSSMDisplay = ['Lab Name', 'Address'];
                                ...
                                if (event.features && event.features.length) {
                                    if (maxfeatures === 1) {
                                        ...
                                        //    var array_key = tapkey;
                                            ...
                                            var array_key_display = wqpdkeyDisplay;
                                            test_val = 'wqpd';
                                        } else if (event.features[0].id.split('.')[0] === 'nwash_lab_registration') {
                                            var array_key = wqlDWSSMkey;
                                            var array_key_display = wqlDWSSMDisplay;
                                            test_val = 'wqpd';
                                        }
                                        ...
                                        for (var im = 0; im < event.features.length; im++) {
                                            ...
                                            if (selectedLayer.length > 1) {
                                                ...
                                                if (event.features[im].id.split('.')[0] === 'project_details' && selectedLayer[0].getVisible()) {
                                                    ...
                                                    var array_key = pipekey;
                                                    var array_key_display = pipekeyDisplay;
                                                //} else if (event.features[im].id.split('.')[0] === 'tap') {
                                                //    //ikey = 4;
                                                //    var array_key = tapkey;
                                                //    var array_key_display = tapkeyDisplay;
                                                    ...
                                                    var array_key = junctionkey;
                                                    var array_key_display = junctionkeyDisplay;
                                                //} else if (event.features[im].id.split('.')[0] === 'project_details_fun' && selectedLayer[6].getVisible()) {
                                                //    ikey = 7;
                                                //    var array_key = [];
                                                //} else if (event.features[im].id.split('.')[0] === 'project_details_sustain' && selectedLayer[7].getVisible()) {
                                                //    ikey = 8;
                                                //    var array_key = [];
    ...
    this.showAllIdentifyLayers = function () {
        ...
        var layer_group_labels = ["Basemap", "Road Network", "Water Supply Projects", "Wash Plan SDG","Water Quality Lab"];
        var layer_groups = [basemap, lrnGroup, wspGroup, wpsdgGroup, labGroup];
...
function get_urban_san_photos(layer, resultObj, title) {
    //var photo_url = "https://nwash2.softwel.com.np/images/urban_sanitation/";
...
function get_photos(layer, resultObj, elem) {
    //var photo_url = "https://nwash2.softwel.com.np/" + "images/Inventory/";
    var photo_url = "/Inv/";
    var arr = {};
    arr.reservoir = ['photo1_path_uuid', 'photo2_path_uuid'];
