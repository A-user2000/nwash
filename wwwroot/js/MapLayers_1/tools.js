...
//        {
    ...
    this.showAllIdentifyLayers = function ()
    {
        ...
        var layer_group_labels = ["Basemap", "Road Network", "Water Supply Projects", "Water Quality Parameter Data"];
        var layer_groups = [basemap, lrnGroup, wspGroup, WQParaGroup];
...
{
    var photo_url = "http://nwash2.softwel.com.np/" + "images/Inventory/";
    var arr = {};
...
function get_sustain_count(pro_uuid) {
    $.ajax({
      ...
      //  url: baseurl + 'data/get_sustain_details',
        url: 'http://nwash.softwel.com.np/data/get_sustain_details',
        ...
        success: function (data) {
            $.each(data, function (el) {
               ...
               // $('#' + r + '_view_all_' + el).html('<a href="' + baseurl + 'structure/report_view/' + pro_uuid + '/' + data[el].fiscal_year.replace('/', '-') + '?list_by=province,district,municipality" target="_blank">View All Details >></a>');
                $('#' + r + '_view_all_' + el).html('<a href="http://nwash.softwel.com.np/data/get_sustain_details/structure/report_view/' + pro_uuid + '/' + data[el].fiscal_year.replace('/', '-') + '?list_by=province,district,municipality" target="_blank">View All Details >></a>');
            });
            if (!data.length) {
