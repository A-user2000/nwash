editorApp.NewSourceModel = Backbone.Model.extend({
    defaults: {},
    initialize: function () {
    ...
    sync: function (method, model, options) {
        ...
        options.success = function (resp) {
            ...
            var message = {"layer": "New Source", "success": true, "message": "New Source Saved Successfully."};
        ...
        {
            console.log(resp);
            var message = {"layer": "New Source", "success": false, "message": "Error  Saving Source."};
