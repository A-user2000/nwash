editorApp.SustainabilityFrameworkModel = Backbone.Model.extend({
    defaults: {},
    initialize: function () {
    ...
    sync: function (method, model, options) {
        ...
        options.success = function (resp) {
            ...
            var message = {"layer": "Sustainability Framework", "success": true, "message": "Sustainability Framework Saved Successfully."};
        ...
        {
            console.log(resp);
            var message = {"layer": "Sustainability Framework", "success": false, "message": "Error  Saving Sustainability Framework."};
