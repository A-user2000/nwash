app.GeoCommandAreaModel = app.PolygonModel.fullExtend({
    defaults: {},
    initialize: function () {
    ...
    sync: function (method, model, options) {
        ...
        options.success = function (resp) {
            ...
            var message = {"layer": "canal", "success": true, "message": "Command Area Saved Successfully."};
            app.writeStatusMessage(message);
            
            //model.fetch();
            //console.log(model.collection);
            model.collection.fetch({remove:false});
        ...
        {
            console.log(resp);
            var message = {"layer": "canal", "success": false, "message": "Error  Saving Command Area."};
            app.writeStatusMessage(message);
        }
    ...
    {
        var attrs = clone(geo_commandarea_attrs);
    ...
    delete_feature: function ()
    {
        ...
        {
            $.ajax({
                url: base_url + "draw/geocommandarea/" + pcode + "/" + this.id,
                type: 'DELETE',
