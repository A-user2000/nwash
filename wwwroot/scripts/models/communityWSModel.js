app.CommunityWSModel = app.PointModel.fullExtend({
    defaults: {},
    initialize: function() {
        ...
        options.success = function(resp) {
            ...
            var message = {"layer": "Community Water Supply", "success": true, "message": "Community Water Supply Saved Successfully."};
        ...
        {
            console.log(resp);
            var message = {"layer": "source", "success": false, "message": "Error  Saving Community Water Supply"};
            app.writeStatusMessage(message);
        }
    ...
    setFeatureAttributes: function(feature)
    {
        ...
        feature.name = this.get('com_name');
    },
    get_defaults: function(merge_obj)
    {
        var attrs = clone(community_ws_attrs);
    ...
    delete_feature: function()
    {
        ...
        {
            $.ajax({
                url: base_url + "edit_new_source/community_ws/" + pid + "/" + this.id,
                type: 'DELETE',
