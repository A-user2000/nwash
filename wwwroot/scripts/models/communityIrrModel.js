app.CommunityIrrModel = app.PointModel.fullExtend({
    defaults: {},
    initialize: function() {
        ...
        options.success = function(resp) {
            ...
            var message = {"layer": "Community Irrigation", "success": true, "message": "Community Irrigation Saved Successfully."};
        ...
        {
            console.log(resp);
            var message = {"layer": "source", "success": false, "message": "Error  Saving Community Irrigation"};
            app.writeStatusMessage(message);
        }
    ...
    {
        var attrs = clone(community_irr_attrs);
    ...
    delete_feature: function()
    {
        ...
        {
            $.ajax({
                url: base_url + "edit_new_source/community_irr/" + pid + "/" + this.id,
                type: 'DELETE',
