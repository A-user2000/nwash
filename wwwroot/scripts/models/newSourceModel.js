app.NewSourceModel = app.PointModel.fullExtend({
    defaults: {},
    initialize: function () {
        ...
        options.success = function (resp) {
            ...
            var message = {"layer": "source", "success": true, "message": "Source Saved Successfully."};
        ...
        {
            console.log(resp);
            var message = {"layer": "source", "success": false, "message": "Error  Saving Source."};
            app.writeStatusMessage(message);
        }
    ...
    setFeatureAttributes: function (feature)
    {
        ...
        feature.name = this.get('sou_name');
    },
    get_defaults: function (merge_obj)
    {
        var attrs = clone(source_attrs);
    ...
    delete_feature: function ()
    {
        ...
        {
            $.ajax({
                url: base_url + "edit_new_source/source/" + pid + "/" + this.id,
                type: 'DELETE',
