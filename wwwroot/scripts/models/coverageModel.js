app.coverageModel = app.PolygonModel.fullExtend({
    defaults: {},
    initialize: function () {
    ...
    sync: function (method, model, options) {
        ...
        options.success = function (resp) {
            ...
            var message = {"layer": "coverage", "success": true, "message": "Project Coverage Saved Successfully."};
        ...
        {
            var message = {"layer": "coverage", "success": false, "message": "Error  Saving Project Coverage."};
            app.writeStatusMessage(message);
        }
    ...
    {
        var attrs = clone(coverage_attrs);
    ...
    delete_feature: function ()
    {
        ...
        {
            $.ajax({
                url: base_url + "draw/coverage/" + pid + "/" + this.id,
                type: 'DELETE',
