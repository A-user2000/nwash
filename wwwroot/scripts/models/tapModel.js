app.TapModel = app.PointModel.fullExtend({
    defaults: {},
    initialize: function () {
        ...
        options.success = function (resp) {
            ...
            var message = {"layer": "tap", "success": true, "message": "Tap Saved Successfully."};
        ...
        {
            console.log(resp);
            var message = {"layer": "tap", "success": false, "message": "Error  Saving Tap."};
            app.writeStatusMessage(message);
        }
    ...
    setFeatureAttributes: function (feature)
    {
        ...
        feature.name = this.get('tap_no');
    },
    get_defaults: function (merge_obj)
    {
        var attrs = clone(tap_attrs);
    ...
    delete_feature: function ()
    {
        ...
        {
            $.ajax({
                url: base_url + "draw/tap/" + pid + "/" + this.id,
                type: 'DELETE',
                success: function (result) {
                    ...
                    {
                        alert("Failed to delete this Tap");
                    }
                },
                error: function (e)
                {
