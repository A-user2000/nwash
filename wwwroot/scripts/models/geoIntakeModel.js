app.GeoIntakeModel = app.PointModel.fullExtend({
    defaults: {},
    initialize: function () {
        ...
        options.success = function (resp) {
            ...
            var message = {"layer": "canal", "success": true, "message": "Intake Saved Successfully."};
        ...
        {
            console.log(resp);
            var message = {"layer": "canal", "success": false, "message": "Error  Saving Intake."};
            app.writeStatusMessage(message);
        }
    ...
    delete_feature: function ()
    {
        ...
        {
            $.ajax({
                url: base_url + "draw/geointake/" + pcode + "/" + this.id,
                type: 'DELETE',
