app.GeoCanalModel = app.LineModel.fullExtend({
    defaults: {
    },
    initialize: function () {
    ...
    sync: function (method, model, options) {
        ...
        options.success = function (resp) {
            ...
            var message = {"layer": "Pipe", "success": true, "message": "Pipe Saved Successfully."};
        ...
        {
            console.log(resp);
            var message = {"layer": "Pipe", "success": false, "message": "Error Saving Pipe."};
            app.writeStatusMessage(message);
        }
    ...
    {
        var attrs = clone(geo_canal_attrs);
    ...
    delete_feature: function ()
    {
        ...
        {
            $.ajax({
                url: base_url + "draw/geocanal/" + pid + "/" + this.id,
                type: 'DELETE',
