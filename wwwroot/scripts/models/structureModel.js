app.StructureModel = app.PointModel.fullExtend({
    defaults: {},
    initialize: function () {
        ...
        options.success = function (resp) {
            ...
            var message = {"layer": "structure", "success": true, "message": "Structure Saved Successfully."};
        ...
        {
            console.log(resp);
            var message = {"layer": "structure", "success": false, "message": "Error  Saving Structure."};
            app.writeStatusMessage(message);
        }
    ...
    setFeatureAttributes: function (feature)
    {
        ...
        feature.name = this.get('str_no');
    },
    get_defaults: function (merge_obj)
    {
        var attrs = clone(structure_attrs);
    ...
    delete_feature: function ()
    {
        ...
        {
            $.ajax({
                url: base_url + "draw/structure/" + pid + "/" + this.id,
                type: 'DELETE',
                success: function (result) {
                    ...
                    {
                        alert("Failed to delete this structure");
                    }
                },
                error: function (e)
                {
