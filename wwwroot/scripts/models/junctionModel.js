app.JunctionModel = app.PointModel.fullExtend({
    defaults: {},
    initialize: function () {
        ...
        options.success = function (resp) {
            ...
            var message = {"layer": "junction", "success": true, "message": "Junction Saved Successfully."};
        ...
        {
            console.log(resp);
            var message = {"layer": "junction", "success": false, "message": "Error  Saving Junction."};
            app.writeStatusMessage(message);
        }
    ...
    setFeatureAttributes: function (feature)
    {
        ...
        feature.name = this.get('junc_no');
    },
    get_defaults: function (merge_obj)
    {
        var attrs = clone(junction_attrs);
        console.log(junction_attrs);
    ...
    delete_feature: function ()
    {
        ...
        {       
            $.ajax({
                url: base_url + "draw/junction/" + pid + "/" + this.id,
                type: 'DELETE',
                success: function (result) {
                    ...
                    {
                        alert("Failed to delete this Junction");
                    }
                },
                error: function (e)
                {
